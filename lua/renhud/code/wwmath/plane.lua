-- Based on PlaneClass within Code/WWMath/plane.cpp/h
...
STATIC.Class = "PlaneClass"
local isHotload = not table.IsEmpty( STATIC )

--- @class PlaneInstance
--- @field Static PlaneClass The static table for this instance's class
local INSTANCE = robustclass.Register( "Renegade_Plane" )
INSTANCE.Class = "PlaneInstance"
...
function INSTANCE:Set( ... )
    ...
    typecheck.AssertArgCount( INSTANCE.Class, argCount, { 0, 2, 3, 4 } )
    ...
    if argCount == 4 then
        ...
        typecheck.AssertArgType( INSTANCE.Class, 3, thirdArg, "number" )
        typecheck.AssertArgType( INSTANCE.Class, 4, fourthArg, "number" )
