-- Based on RectClass within Code/WWMath/rect.h
...
--- @class RectInstance
--- @field Static RectClass The static table for this instance's class
local INSTANCE = robustclass.Register( "Renegade_Rect" )
INSTANCE.Class = "RectInstance"
...
function INSTANCE:Renegade_Rect( ... )
    ...
    if argCount == 1 then
        ...
        typecheck.AssertArgType( INSTANCE.Class, 1, rect, "RectInstance" )
    ...
    if argCount == 2 then
        ...
        typecheck.AssertArgType( INSTANCE.Class, 1, topLeft, "Vector" )
        typecheck.AssertArgType( INSTANCE.Class, 2, bottomRight, "Vector" )
    ...
    if argCount == 4 then
        ...
        typecheck.AssertArgType( INSTANCE.Class, 1, left,   "number" )
        typecheck.AssertArgType( INSTANCE.Class, 2, top,    "number" )
        typecheck.AssertArgType( INSTANCE.Class, 3, right,  "number" )
        typecheck.AssertArgType( INSTANCE.Class, 4, bottom, "number" )
