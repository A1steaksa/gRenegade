-- Based on FontCharsClass within Code/ww3d2/render2dsentence.cpp/h
...
STATIC.Class = "FontCharsClass"
local isHotload = not table.IsEmpty( STATIC )

--- @class FontCharsInstance
--- @field Static FontCharsClass The static table for this instance's class
local INSTANCE = robustclass.Register( "Renegade_FontChars" )
INSTANCE.Class = "FontCharsInstance"
