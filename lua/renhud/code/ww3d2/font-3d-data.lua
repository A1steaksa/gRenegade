-- Based on Font3DDataClass within Code/ww3d2/font3d.cpp/h
...
STATIC.Class = "Font3dDataClass"
local isHotload = not table.IsEmpty( STATIC )

--- @class Font3dDataInstance
--- @field Static Font3dDataClass The static table for this instance's class
local INSTANCE = robustclass.Register( "Renegade_Font3dData" )
INSTANCE.Class = "Font3dDataInstance"
