    ...
    function INSTANCE:CopySettings( definition )
        ...
        if combatManagerClass.IAmServer() then
            ...
            for index, scriptName in ipairs( definition.ScriptNameList ) do
                ...
                -- Omitting or disabling script creation due to that not being implemented and looking like it requires DLL loading
                -- which isn't something I want to deal with right now
