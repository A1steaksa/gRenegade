...
STATIC.Class = "FrustumClass"
local isHotload = not table.IsEmpty( STATIC )

--- @class FrustumInstance
--- @field Static FrustumClass The static table for this instance's class
local INSTANCE = robustclass.Register( "Renegade_Frustum" )
INSTANCE.Class = "FrustumInstance"
...
function INSTANCE:Init( camera, viewplaneMin, viewplaneMax, zNear, zFar )
    ...
    self.Planes = {}
    self.Planes[0] = planeClass.New( corners[0], corners[3], corners[1] ) -- Near
    self.Planes[1] = planeClass.New( corners[0], corners[5], corners[4] ) -- Bottom
    self.Planes[2] = planeClass.New( corners[0], corners[6], corners[2] ) -- Right
    self.Planes[3] = planeClass.New( corners[2], corners[7], corners[3] ) -- Top
    self.Planes[4] = planeClass.New( corners[1], corners[7], corners[5] ) -- Left
    self.Planes[5] = planeClass.New( corners[4], corners[7], corners[6] ) -- Far
