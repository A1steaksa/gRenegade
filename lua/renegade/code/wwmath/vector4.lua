...
STATIC.Class = "Vector4Class"
local isHotload = not table.IsEmpty( STATIC )

--- @class Vector4Instance
--- @field Static Vector4Class The static table for this instance's class
local INSTANCE = robustclass.Register( "Renegade_Vector4" )
INSTANCE.Class = "Vector4Instance"
...
function INSTANCE:Renegade_Vector4( ... )
    ...
    typecheck.AssertArgCount( INSTANCE.Class, argCount, { 0, 1, 4 } )
    ...
    if argCount == 1 then
        typecheck.AssertArgType( INSTANCE.Class, 1, args[1], { "Vector4Instance", "table" } )
...
--[[ Operators ]] do
    ...
    function INSTANCE:__mul( a, b )
        typecheck.AssertArgType( INSTANCE.Class, 1, a, { "Vector4Instance", "number" } )
        typecheck.AssertArgType( INSTANCE.Class, 2, b, { "Vector4Instance", "number" } )
